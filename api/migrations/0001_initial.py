    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_type', models.CharField(choices=[('blog', 'Blog'), ('project', 'Project')], max_length=10)),
                ('image', models.ImageField(blank=True, default='post_images/default.png', null=True, upload_to='post_images/')),
